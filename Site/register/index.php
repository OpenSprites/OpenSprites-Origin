...
<body>
    ...
    <div class="container main" style="height:700px;">
        <div class="main-inner">
            ...
            <iframe scrolling="no" src="http://opensprites.gwiddle.co.uk/forums/?p=user/join&return=http://dev.opensprites.gwiddle.co.uk/&iframe=true" style="width: 100%; height: 570px;overflow: hidden;border: none;"></iframe>
        </div>
    </div>
