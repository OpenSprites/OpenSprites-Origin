(function () {
    $(function () {
        if(localStorage['cookies'] === undefined) {
            ...
            $('head').append('<style>#cookielaw-text {position:absolute;left:40px;font-size:21px;height:27px;line-height:24px;z-index:99999;} #cookielaw {position:fixed;bottom:0;right:0;width:100%;font-size:18px;line-height:18px;padding:12px;background:rgb(174,207,54);color:black;}</style>');
