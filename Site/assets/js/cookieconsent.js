(function () {
    $(function () {
        if(sGeobytesMapReference === 'Europe ' && localStorage['cookies'] === undefined) {
            ...
            $('body').prepend('<div id="cookielaw"><div id="cookielaw-text">We use cookies on this site. By using this site or closing this message, you are allowing us to use cookies.</div><a href="javascript:$(\'#cookielaw\').fadeOut(300);localStorage[\'cookies\'] = true;" class="btn blue" style="float: right; width: 100px; text-align:center;">Close</a></div>');
        }
    });
})();
