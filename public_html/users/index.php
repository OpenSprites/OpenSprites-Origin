                ...
                <?php if ($user_exist) { ?>
                    <div id='username'>
                        ...
                        if ($username == $logged_in_user) {
                            ...
                            echo htmlspecialchars($username) . " (#" . $user['userid'] . ")";
                        }
                        ?>
                    </div>
                    <div id='description'>
                            ...
                            <div id="admin-group-container">
                                ...
                                <script type='text/javascript'>
                                    ...
                                    $("#admin-set-group").click(function () {
                                        ...
                                        $.post("/users/admin-set-group.php", {
                                            userid: OpenSprites.view.user.id,
                    ...
                    <div id="actions-container">
                        <div id='main-actions'>
                            <div id='follow' class='main-action'>
                                <a href="https://scratch.mit.edu/users/<?php echo urlencode($username); ?>"
                                   target="blank">View Scratch Page</a>
                            </div>
        ...
        <div class="main-inner">
            ...
            <div id="about">
                ...
                <p style='position: absolute; margin: auto; top: 480px; left: 0; right: 0; width: 50%; text-align: center; font-size: 18px;'>
                    We couldn't find the user you're looking for.<br>You may want to <a href='/'>go back to the main
                        page</a>.</p>
            </div>
        </div>
    </div>
...
<?php if ($username == $logged_in_user) { ?>
    ...
    <div class="modal edit-profile">
        <div class="modal-content">
            ...
            <p><i>Profile Background</i><br>You can set a color for your background on this profile page, or simply just
                use your avatar image.</p>
            ...
            <p><i>Location</i><br>If you want to let people know which country you live in, you can tell them. Be warned
                - don't give away your exact location!</p>
            ...
            <p><i>About Me</i><br>Write something about yourself! Make sure it doesn't have your phone number, address,
                social links, or anything else that is against the <a href='/guidelines/'>Community Guidelines</a>.
                About sections support <a href='https://help.github.com/articles/github-flavored-markdown/'>Markdown</a>.
            </p>
    ...
    <div class="modal leaving">
        <div class="modal-content">
            ...
            <p class="leaving-desc">
                ...
                Sites that aren't OpenSprites (or Scratch!) have the potential to be dangerous, or could have unwanted
                content.<br/><br/>
