...
<body>
	...
	<div class="container main">
		<div class="main-inner">
			<h1>Send a Report</h1>
			<p>Use the form below to report something that needs moderator attention. Do not report unless you think something has violated our <a href='/guidelines/' target='_blank'>Community Guidelines</a> or <a href='/tos/' target='_blank'>Terms of Service</a>; unnecessary reports prevent moderators from addressing real issues. <br/>Make sure to include a short and descriptive reason for your report, with additional links if required.</p>
