...
$(".ok").click(function(){
	...
	$(".script-check:checked").each(function(){
		...
		var data = '<svg xmlns="https://www.w3.org/2000/svg" width="200" height="200">' +
			...
			'<div xmlns="https://www.w3.org/1999/xhtml" style="font-size: 40px;background:white;height:100%;">' +
				pre.html() +
				"<style type='text/css'>\n" +
					stylesheet +
				"\n</style>" +
...
function processFiles(files){
	...
	if(addedFiles != totalFiles){
		$("#upload-status p").text("Some files unrecognized. We support the formats: PNG, JPEG, GIF, SVG, MPEG-3, WAV, Scripts in the JSON format specified by MIT Scratch.");
	} else {
