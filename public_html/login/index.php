...
<body>
    ...
    <div class="container main" style="height:440px;">
        <div class="main-inner">
            ...
            <iframe scrolling="no" src="http://opensprites.org/forums/?p=user/login&return=http://opensprites.gwiddle.co.uk/&iframe=true" style="width: 100%; height: 300px;overflow: hidden;border: none;margin-top: -50px"></iframe>
        </div>
    </div>
