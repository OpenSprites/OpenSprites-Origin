...
<body>
	...
	<script>
		...
		model = OpenSprites.models.SortableAssetList($("#feat-assets-list"));
		model = OpenSprites.models.SortableAssetList($("#top-collections-list"));
		model = OpenSprites.models.SortableAssetList($("#featured-collections"));
	</script>
</body>
</html>
