...
// verify that each asset exists and is in the collection
...
for($i=0;$i<sizeof($assets);$i++){
	removeFromCollection($userId, $id, $assets[$i]);
}

echo json_encode(array("status" => "success", "message" => "Assets removed"));
?>